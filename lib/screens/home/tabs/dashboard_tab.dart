            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Macro + Smart Suggestion Section
                    FadeInUp(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Consumer<NutritionProvider>(
                              builder: (context, provider, child) {
                                final carbPercent =
                                    provider.carbsConsumed / provider.carbsTarget;
                                final proteinPercent =
                                    provider.proteinConsumed /
                                    provider.proteinTarget;
                                final fatPercent =
                                    provider.fatConsumed / provider.fatTarget;

                                if (proteinPercent < carbPercent &&
                                    proteinPercent < fatPercent) {
                                  final need =
                                      (provider.proteinTarget -
                                              provider.proteinConsumed)
                                          .round();
                                  return _buildSmartSuggestion(
                                    ...
                                    message:
                                        'Butuh +$need g lagi. Coba telur, ayam, atau tahu',
                                    color: AppTheme.proteinColor,
                                  );
                                } else if (carbPercent < proteinPercent &&
                                    carbPercent < fatPercent) {
                                  final need =
                                      (provider.carbsTarget -
                                              provider.carbsConsumed)
                                          .round();
                                  return _buildSmartSuggestion(
                                    icon: '🍚',
                                    title: 'Karbohidrat kurang',
                                    message:
                                        'Butuh +$need g lagi. Nasi merah atau ubi bisa jadi pilihan',
                                    color: AppTheme.carbColor,
                                  );
                                } else if (fatPercent < carbPercent &&
                                    fatPercent < proteinPercent) {
                                  final need =
                                      (provider.fatTarget - provider.fatConsumed)
                                          .round();
                                  return _buildSmartSuggestion(
                                    icon: '🥑',
                                    title: 'Lemak sehat kurang',
                                    message:
                                        'Butuh +$need g lagi. Alpukat atau kacang-kacangan',
                                    color: AppTheme.fatColor,
                                  );
                                }
