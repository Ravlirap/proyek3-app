...
import 'screens/onboarding/date_of_birth_screen.dart';
        ...
        builder: (context, languageProvider, child) {
          return MaterialApp(
            ...
            routes: {
              ...
              AppConstants.onboardingDateRoute: (_) => const DateOfBirthScreen(),
              AppConstants.onboardingHeightRoute: (_) => const HeightScreen(),
              AppConstants.onboardingWeightRoute: (_) => const WeightScreen(),
              AppConstants.homeRoute: (_) => const HomeScreen(),
              AppConstants.scanRoute: (_) => const ScanScreen(),
              AppConstants.analysisResultRoute: (_) => const AnalysisResultScreen(),
