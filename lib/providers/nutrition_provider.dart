...
class NutritionProvider with ChangeNotifier {
  ...
  // Target kalori per jenis makan
  double get targetBreakfast => calorieTarget * 0.25;
  double get targetLunch => calorieTarget * 0.35;
  double get targetDinner => calorieTarget * 0.30;
  double get targetSnack => calorieTarget * 0.10;

  // Kalori yang sudah dikonsumsi per jenis makan
